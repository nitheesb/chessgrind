...
export const TRAPS: Trap[] = [
  ...
  },
  {
    ...
    description: 'A tricky gambit where Black sacrifices a knight to lure White into a devastating mating attack.',
    explanation: [
      'Black plays the surprising Nd4 instead of the usual Bc5 or Nf6',
      'White greedily takes Nxe5, and after Qg5 the threats multiply',
      'Nxf7 looks strong but Qxg2 attacks f1 and threatens mate',
      'After Rf1 Qxe4+ Be2, the stunning Nf3# delivers checkmate'
    ],
    difficulty: 'beginner',
    side: 'black',
    xpReward: 30,
  },
  {
    ...
    description: 'Black sacrifices a knight to pry open the h-file and launch a devastating kingside attack against White\'s castled king.',
    explanation: [
      'Black plays the provocative Ng4 and h5, offering the knight',
      'After hxg4 hxg4, the h-file is blown open toward White\'s king',
      'White\'s knight is driven away and Qh4 creates unstoppable threats',
      'The pawn on g3 cracks open the king\'s shelter for a decisive attack'
    ],
    difficulty: 'intermediate',
    side: 'black',
    xpReward: 40,
  },
  {
    ...
    fen: 'r1b1kb1r/ppqp1ppp/2n1pn2/8/2B1P3/2N2N2/PP2QPPP/R1B2RK1 b kq - 5 8',
    description: 'A dangerous trap in the Smith-Morra Gambit where Black targets the weakened f2 square and the exposed white king.',
    explanation: [
      'Black develops naturally with Qc7 and Nf6, targeting key squares',
      'After White plays Qe2, Black strikes with the aggressive Ng4',
      'The knight threatens Qxh2# and attacks the f2 pawn',
      'White faces serious difficulties defending against the multiple threats'
    ],
    difficulty: 'intermediate',
    side: 'black',
    xpReward: 40,
  },
  {
    ...
    description: 'One of the oldest known traps in chess, dating back centuries. Black traps White\'s bishop on b3 with a pawn advance.',
    explanation: [
      'Black plays b5 and Nxd4, luring White into taking the d4 pawn',
      'After Qxd4 c5, the queen is driven back and c4 is threatened',
      'White\'s queen maneuvers are futile as c4 traps the Bb3',
      'The bishop is caught like an animal in Noah\'s Ark - no escape!'
    ],
    difficulty: 'advanced',
    side: 'black',
    xpReward: 50,
