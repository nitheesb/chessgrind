...
export type PieceStyleType = 'standard' | 'neo' | 'classic' | 'minimal'
...
// Neo style - modern flat design with gradient fills
const NeoPieceSVGs: Record<string, (isWhite: boolean) => React.ReactNode> = {
  K: (isWhite) => (
    <g>
      <path d="M22.5 11.63V6" fill="none" stroke={isWhite ? '#333' : '#ddd'} strokeWidth="2" strokeLinejoin="round"/>
      <path d="M20 8h5" fill="none" stroke={isWhite ? '#333' : '#ddd'} strokeWidth="2" strokeLinejoin="round"/>
      <path 
        d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5"
        fill={isWhite ? '#f8f8f8' : '#2a2a2a'}
        stroke={isWhite ? '#555' : '#aaa'}
        strokeWidth="1.5"
      />
      <path 
        d="M11.5 37c5.5 3.5 15.5 3.5 21 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-3.5-7.5-13-10.5-16-4-3 6 5 10 5 10V37z"
        ...
        strokeWidth="1.5"
      />
      <path d="M11.5 30c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0m-21 3.5c5.5-3 15.5-3 21 0" fill="none" stroke={isWhite ? '#bbb' : '#666'} strokeWidth="1"/>
    </g>
  ),
  Q: (isWhite) => (
    <g>
      {[6, 14, 22.5, 31, 39].map((cx, i) => (
        <circle key={i} cx={cx} cy={[12, 9, 8, 9, 12][i]} r="2.5" fill={isWhite ? '#f8f8f8' : '#2a2a2a'} stroke={isWhite ? '#555' : '#aaa'} strokeWidth="1.5"/>
      ))}
      <path 
        d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-3.5-14.5-5 13.5-5-14-5 13.5L9 25l-2.5 1z"
        fill={isWhite ? '#f8f8f8' : '#2a2a2a'}
      ...
      <path 
        ...
        strokeWidth="1.5"
      />
      <path d="M11 38.5a35 35 1 0 0 23 0M11 29a35 35 1 0 1 23 0m-21.5 2.5h20m-21 3a35 35 1 0 0 22 0m-23 3a35 35 1 0 0 24 0" fill="none" stroke={isWhite ? '#bbb' : '#666'} strokeWidth="1"/>
    </g>
  ),
  R: (isWhite) => (
    <g fill={isWhite ? '#f8f8f8' : '#2a2a2a'} stroke={isWhite ? '#555' : '#aaa'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 39h27v-3H9v3zM12 36v-4h21v4H12zM11 14V9h4v2h5V9h5v2h5V9h4v5"/>
      <path d="M34 14l-3 3H14l-3-3"/>
      <path d="M31 17v12.5H14V17" strokeLinejoin="miter"/>
      <path d="M31 29.5l1.5 2.5h-20l1.5-2.5"/>
  ...
  B: (isWhite) => (
    <g fill={isWhite ? '#f8f8f8' : '#2a2a2a'} stroke={isWhite ? '#555' : '#aaa'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2z"/>
      <circle cx="22.5" cy="8" r="2.5"/>
      <path d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5" fill="none" stroke={isWhite ? '#bbb' : '#666'}/>
    </g>
  ),
  N: (isWhite) => (
    <g fill={isWhite ? '#f8f8f8' : '#2a2a2a'} stroke={isWhite ? '#555' : '#aaa'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21"/>
      <path d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.042-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4.003 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.994-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-1.992 2.5-3c1 0 1 3 1 3"/>
      <circle cx="9" cy="25.5" r="0.5" fill={isWhite ? '#555' : '#aaa'}/>
      <path d="M14.933 15.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z" fill={isWhite ? '#555' : '#aaa'}/>
    </g>
  ),
  P: (isWhite) => (
    <path 
